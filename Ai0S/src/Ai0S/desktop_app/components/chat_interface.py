...
class ChatInterface(ctk.CTkFrame):
    ...
    def __init__(self, parent, theme=None, on_message_send: Callable[[str], None] = None,
    ...
    def _setup_text_formatting(self) -> None:
        ...
        text_widget.tag_configure(
            ...
            background=professional_theme.get_color("bg_tertiary", "light"),  # Use solid color instead of transparency
            relief="solid",
            borderwidth=1,
            lmargin1=20,
            lmargin2=20,
        ...
        text_widget.tag_configure(
            ...
            background="#FECACA",  # Light red background for error messages
            relief="solid",
            borderwidth=1,
            lmargin1=20,
            lmargin2=20,
    ...
    def set_execution_callback(self, callback: Callable) -> None:
        """Set the execution callback for handling task execution updates."""
