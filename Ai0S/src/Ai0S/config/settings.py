...
class Settings(BaseSettings):
    ...
    def visual_settings(self) -> Dict[str, Any]:
        """Get visual monitoring configuration."""
        return {
            "capture_interval": 2.0,
            "enable_ai_analysis": True,
            "enable_change_detection": True,
            "max_history_size": 50,
            "screenshot_quality": int(self.SCREENSHOT_QUALITY * 100)
        }
    ...
    def voice_settings(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "detection_timeout": getattr(self, 'VOICE_DETECTION_TIMEOUT', 30),
            "wake_word_sensitivity": getattr(self, 'WAKE_WORD_SENSITIVITY', 0.7),
            "language": getattr(self, 'SPEECH_LANGUAGE', 'en-US')
        }
