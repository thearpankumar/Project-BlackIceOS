...
class EncryptionManager:
    ...
    def encrypt_google_genai_key(self, google_key: str) -> str:
        ...
        if not google_key.startswith('AIza'):
            raise ValueError("Invalid Google Generative AI API key format (should start with 'AIza')")
    ...
    def get_key_info(self) -> dict:
        ...
        return {
            ...
            "key_prefix": self.encryption_key[:8] + "..." if self.encryption_key else None
        }
...
def decrypt_api_key(encrypted_api_key: str, encryption_key: Optional[str] = None) -> str:
    """
    Decrypt an API key
